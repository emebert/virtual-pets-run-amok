...
writeLine(
"How would you like to interact with the animals in the shelter?");
writeLine(
"Enter 'feed', 'water','clean', 'provide oil', 'walk'. To quit, enter 'quit.");
...
default:
writeLine("Invalid entry. Your options are 'feed', 'water','clean', 'provide oil', 'walk'. To quit, enter 'quit.");
break;
